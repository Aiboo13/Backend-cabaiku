...
<div class="field">
    ...
    @if($isEdit && $artikel->gambar)
        <div style="margin-bottom:8px;"><img src="{{ asset('storage/' . $artikel->gambar) }}" alt="Gambar" style="max-width:200px;max-height:150px;object-fit:cover;border:1px solid #ddd;padding:4px;"></div>
    @endif
