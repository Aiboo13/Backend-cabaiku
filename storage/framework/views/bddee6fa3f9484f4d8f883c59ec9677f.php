...
<div class="field">
    ...
    <?php if($isEdit && $artikel->gambar): ?>
        <div style="margin-bottom:8px;"><img src="<?php echo e(asset('storage/' . $artikel->gambar)); ?>" alt="Gambar" style="max-width:200px;max-height:150px;object-fit:cover;border:1px solid #ddd;padding:4px;"></div>
    <?php endif; ?>
...
<?php /**PATH D:\kuliah\semester4\projek semster 4\Backend-cabaiku\Backend-Cabaiku\resources\views/admin/artikels/partials/form.blade.php ENDPATH**/ ?>